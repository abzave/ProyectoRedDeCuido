...
@errorMessage as varchar(50) = null out
as begin
	if @idCliente is null and @baneado is null  and @idProvincia is null and @provincia is null
			and @idUsuario is null begin
		set @errorMessage = 'Debe ingresar al menos un parametro';
		raiserror(@errorMessage, 1, 6);
		return;
...
@errorMessage as varchar(50) = null out
as begin
	if @idPersonal is null and @disponible is null and @idCentro is null and @nombreCentro is null
			and @idHorario is null and @tiempo is null and @idUsuario is null begin
		set @errorMessage = 'Debe ingresar al menos un parametro';
		raiserror(@errorMessage, 1, 6);
		return;
	end
	...
	and (@idUsuario is null or idUsuario = @idUsuario) and disponible = ISNULL(@disponible, disponible)
end
go
